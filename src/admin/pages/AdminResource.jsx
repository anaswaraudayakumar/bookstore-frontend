    ...
    <>
      ...
      <div className='md:grid grid-cols-5 gap-2'>
        ...
        <div className='col-span-4 p-10 '>
          ...
          {/* tab contents */}
          {currentTab == 1 &&   <div className='md:grid grid-cols-4 w-full my-5'>
          ...
          {currentTab == 2 &&   <div className='md:grid grid-cols-3 w-full my-5'>
          {/* duplicate according to user */}
          <div className="rounded bg-gray-200 p-2 m-2">
            <p className='text-red-500 font-bold text-md'>ID:</p>
            <div className='flex mt-3 items-center'><img width={'80px'} height={'80px'} style={{borderRadius:"50%"}} src="https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_1280.png" alt="user" />
